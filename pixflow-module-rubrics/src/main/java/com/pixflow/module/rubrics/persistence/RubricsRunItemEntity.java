...
public class RubricsRunItemEntity {
    ...
    public void setSubjectSnapshotHash(String value) {
        subjectSnapshotHash = value;
    }
    ...
    public void setPassRate(java.math.BigDecimal value) {
        passRate = value;
    }

    public java.math.BigDecimal getCoverage() {
        return coverage;
    }

    public void setCoverage(java.math.BigDecimal value) {
        coverage = value;
    }
    ...
    public void setEvidencePackHash(String value) {
        evidencePackHash = value;
    }
    ...
    public RunItemStatus getStatus() {
        return status;
    }

    public void setStatus(RunItemStatus status) {
        this.status = status;
    }
