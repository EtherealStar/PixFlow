...
public class AgentProperties {
    ...
    public void setSessionMemory(SessionMemory sessionMemory) { this.sessionMemory = sessionMemory; }
    ...
    public static class Prompt {
        ...
        public SectionCache getSectionCache() { return sectionCache; }
        public void setSectionCache(SectionCache sectionCache) { this.sectionCache = sectionCache; }
    ...
    public static class Skill {
        ...
        public int getDescriptionMaxChars() { return descriptionMaxChars; }
        public void setDescriptionMaxChars(int descriptionMaxChars) { this.descriptionMaxChars = descriptionMaxChars; }

        public int getWhenToUseMaxChars() { return whenToUseMaxChars; }
        public void setWhenToUseMaxChars(int whenToUseMaxChars) { this.whenToUseMaxChars = whenToUseMaxChars; }
    }
    ...
    public static class SessionMemory {
        ...
        public int getMaxContentTokens() { return maxContentTokens; }
        public void setMaxContentTokens(int maxContentTokens) { this.maxContentTokens = maxContentTokens; }

        public int getMaxContentBytes() { return maxContentBytes; }
        public void setMaxContentBytes(int maxContentBytes) { this.maxContentBytes = maxContentBytes; }
    ...
    public static class Subagent {
        ...
        public boolean isShareSkillTools() { return shareSkillTools; }
        public void setShareSkillTools(boolean shareSkillTools) { this.shareSkillTools = shareSkillTools; }

        public boolean isShareReadonlyTools() { return shareReadonlyTools; }
        public void setShareReadonlyTools(boolean shareReadonlyTools) { this.shareReadonlyTools = shareReadonlyTools; }
    ...
    public static class PlanMode {
        ...
        public boolean isAutoExitOnCompletion() { return autoExitOnCompletion; }
        public void setAutoExitOnCompletion(boolean autoExitOnCompletion) { this.autoExitOnCompletion = autoExitOnCompletion; }

        public boolean isKeepDraftOnExit() { return keepDraftOnExit; }
        public void setKeepDraftOnExit(boolean keepDraftOnExit) { this.keepDraftOnExit = keepDraftOnExit; }
    }
    ...
    public static class Orchestrator {
        ...
        public int getConversationLockTtlSeconds() { return conversationLockTtlSeconds; }
        public void setConversationLockTtlSeconds(int conversationLockTtlSeconds) { this.conversationLockTtlSeconds = conversationLockTtlSeconds; }
    }
}