...
public final class SseTurnSession {
    private static final Logger log = LoggerFactory.getLogger(SseTurnSession.class);
    ...
    private void finishOwnership() {
        ...
        closeMetric(terminalReason.get() == null
                ...
                : terminalReason.get());
        ownershipClosed.run();
        log.info("SSE turn terminated: turnId={} conversationId={} ownerUserId={} reason={} responseCommitted={}",
    ...
    private static SseTerminationReason terminationReason(CancellationReason reason) {
        return switch (reason) {
            ...
            case CLIENT_DISCONNECTED, CALLER_ABORTED -> SseTerminationReason.CLIENT_DISCONNECTED;
        };
    }
