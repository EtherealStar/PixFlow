...
| `files.md` | Separate Materials and Outputs pages, deletion, naming, and pagination. |
...
4. Long-running state comes from backend snapshots plus event streams; component-local state is not a recovery source.
