...
public class PendingTaskEnqueuer {
    ...
    public PendingTaskEnqueuer(ProcessTaskMapper taskMapper, TaskMessagePublisher publisher,
                               TaskProperties properties, Clock clock) {
    ...
    public void enqueue(long taskId) {
        ...
        try {
            publisher.publish(new TaskMessage(Long.toString(taskId), task.getTaskType(),
    ...
    public void retryPending() {
        for (ProcessTask task : taskMapper.findByStatus(TaskStatus.PENDING,
