...
public class TaskProperties {
  ...
  public static class Worker {
    ...
    public Pool getProcessPool() {
      return processPool;
    }

    public void setProcessPool(Pool processPool) {
      this.processPool = processPool;
    }

    public Pool getImagegenPool() {
      return imagegenPool;
    }

    public void setImagegenPool(Pool imagegenPool) {
      this.imagegenPool = imagegenPool;
    }
  ...
  public static class Download {
    ...
    public Duration getSingleUrlExpiry() {
      return singleUrlExpiry;
    }

    public void setSingleUrlExpiry(Duration singleUrlExpiry) {
      this.singleUrlExpiry = singleUrlExpiry;
    }
