...
public class TaskMetrics {
  ...
  public void recordCancel(String state) {
    Counter.builder("pixflow.task.cancel").tag("state", state).register(registry).increment();
  }
  ...
  public void recordHeartbeat(String result) {
    Counter.builder("pixflow.task.heartbeat").tag("result", result).register(registry).increment();
  }
