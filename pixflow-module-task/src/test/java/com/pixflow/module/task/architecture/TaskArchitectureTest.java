...
class TaskArchitectureTest {
  ...
  static final ArchRule should_not_depend_on_module_file =
      noClasses()
          .that()
          .resideInAPackage("com.pixflow.module.task..")
          .should()
          .dependOnClassesThat()
          .resideInAPackage("com.pixflow.module.file..");
  ...
  static final ArchRule should_not_depend_on_agent =
      noClasses()
          ...
          .should()
          .dependOnClassesThat()
          .resideInAPackage("com.pixflow.agent..");
  ...
  static final ArchRule should_not_depend_on_harness_loop =
      noClasses()
          ...
          .should()
          .dependOnClassesThat()
          .resideInAPackage("com.pixflow.harness.loop..");
  ...
  static final ArchRule capability_workers_must_not_commit_or_publish =
      noClasses()
          .that()
          .haveSimpleName("ProcessWorker")
          .or()
          .haveSimpleName("ImageGenWorker")
          .or()
          .haveSimpleName("FailureIsolator")
          .or()
          .haveSimpleName("WorkUnitScheduler")
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage(
